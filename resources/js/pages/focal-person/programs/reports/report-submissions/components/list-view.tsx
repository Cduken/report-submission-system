...
export default function ListView({
    ...
    return (
        <div className="space-y-2">
            {/* Table Header */}
            <div className="ml-8 flex items-center gap-4 px-3 py-2 text-xs font-medium text-muted-foreground lg:ml-0 lg:gap-4 lg:px-4">
                <div className="lg:w-10"></div>
                <div className="ml-3 flex-1 lg:ml-0 lg:min-w-0">Name</div>
                <div className="lg:w-32">Updated At</div>
            ...
            {reportSubmissions.map((submission) => (
                ...
                >
                    ...
                    <div className="ml-2 lg:ml-2 lg:w-32">
                    ...
                    <div className="flex items-center gap-1.5 lg:w-20">
